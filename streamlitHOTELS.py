...
#restaurants = st.sidebar.checkbox('Restaurants Nearby (Quality)')
...
# st.sidebar.slider('Restaurants Nearby', 0, 5, 0)
# st.sidebar.slider('Tourist Attractions Nearby', 0, 5, 0)
# st.sidebar.slider('Art Galleries Nearby', 0, 5, 0)
# st.sidebar.slider('Gyms Nearby', 0, 5, 0)
# st.sidebar.slider('Shopping Malls Nearby', 0, 5, 0)
# st.sidebar.slider('Bars Nearby', 0, 5, 0)
# st.sidebar.slider('Casinos Nearby', 0, 5, 0)
# st.sidebar.slider('Supermarkets Nearby', 0, 5, 0)

# st.sidebar.selectbox('Do you care more about quality or quantity for the above nearby places?', ('Quality','Quantity','Both'))
